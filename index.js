...
http.createServer(async (req, res) => {
    ...
    try {
        if (path === '/api/live') {
            await queryD1("UPDATE prices SET open = 4528.4, high = 4528.4, low = 4518.0, close = 4519.2 WHERE asset = 'XAU_USD' AND date = '2026-08-21' AND high > 4530");
            await queryD1("UPDATE prices SET open = 68.19, high = 68.19, low = 68.08, close = 68.12 WHERE asset = 'XAG_USD' AND date = '2026-08-21' AND high > 68.50");
            const dbRes = await queryD1(
