...
async function ensureHistoricalBaselines() {
    try {
        ...
        // GOLD_MCX
        await upsertPriceRow('GOLD_MCX', '2026-08-23', 162438, 162438, 162438, 162438);
        await upsertPriceRow('GOLD_MCX', '2026-08-22', 162438, 162438, 162438, 162438);
        ...
        // SILVER_MCX
        await upsertPriceRow('SILVER_MCX', '2026-08-23', 246597, 246597, 246597, 246597);
        await upsertPriceRow('SILVER_MCX', '2026-08-22', 246597, 246597, 246597, 246597);
        ...
        // GOLD_999_GST
        await upsertPriceRow('GOLD_999_GST', '2026-08-23', 168188, 168188, 168188, 168188);
        await upsertPriceRow('GOLD_999_GST', '2026-08-22', 168188, 168188, 168188, 168188);
